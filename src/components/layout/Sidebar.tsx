    ...
    return (
      <>
        <header className="fixed top-0 left-0 right-0 h-14 bg-bg-secondary/80 backdrop-blur-md border-b border-border/50 flex items-center justify-center px-4 z-50">
          <h1 className="text-xl font-bold text-white">Retire Early</h1>
        </header>
              ...
              >
                <div
                  className={cn(
                    ...
                    isActive
                      ? "bg-white/10 shadow-[0_0_15px_rgba(255,255,255,0.2)]"
                      : "",
                  )}
                >
                  <span
                ...
                <span
                  className={cn(
                    ...
                    isActive ? "text-white font-bold" : "opacity-80",
                  )}
                >
                  {item.label}
                </span>
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-bg-secondary/50 backdrop-blur-xl border-r border-border flex flex-col z-40">
      <div className="h-16 flex items-center px-6 border-b border-border/50">
        <h1 className="text-2xl font-bold text-white">Retire Early</h1>
      </div>
